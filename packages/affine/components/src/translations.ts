...
/**
 * The carousel's own two words (`docs/adr/0027`). The PAGE names are not
...
export const PALETTE_GROUP_CHOOSE: ChromeWording = [
  'com.labre.color-picker.palette.choose',
  'Choose a palette',
];
