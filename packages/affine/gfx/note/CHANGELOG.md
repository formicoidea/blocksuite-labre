...
- 2764603: Reword three English defaults: the note-index badge tooltips now say "Hidden on document" and "Document mode index", and the note display-mode option says "In Canvas Only".
