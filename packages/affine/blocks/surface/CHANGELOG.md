...
- 4ab8a5b: fix(edgeless): A\* connector routing dequeues its frontier in the right order again, so orthogonal connectors take the shortest, least-bent path
...
- 9fa662a: fix(edgeless): a selected qualification value can be un-picked again
...
- e9cd7e1: The editor-anchored info panel — "What this map says about this component" and
