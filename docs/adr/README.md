...
| [0029](0029-labre-accent.md)                                   | The editor ships Labre's accent      | accepted                  | `#2563eb` re-points the upstream accent, derived not listed, chrome and canvas from one value and one seam.   |
