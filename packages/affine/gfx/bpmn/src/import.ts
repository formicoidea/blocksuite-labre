 ...
 * | a carried element whose id another carried element already claimed | **lost on export** | the first is written and the rest are not — a BPMN id is unique across a document. They stay in the document; the export names them |
