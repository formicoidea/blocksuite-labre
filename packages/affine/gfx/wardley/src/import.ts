 ...
 * | a statement with NO coordinates (`anchor Client`)                     | **lost**    | the reader lays one out and says so; the export then writes the coordinates we invented, not the silence the file had  |
