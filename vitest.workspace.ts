...
export default [
  ...
  'packages/affine/blocks/surface-ref/vitest.config.ts',
  ...
  'packages/affine/gfx/bpmn/vitest.browser.config.ts',
  ...
  'packages/affine/gfx/wardley/vitest.browser.config.ts',
