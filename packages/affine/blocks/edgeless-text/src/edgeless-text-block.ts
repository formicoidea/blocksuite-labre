...
export class EdgelessTextBlockComponent extends GfxBlockComponent<EdgelessTextBlockModel> {
  static override styles = css`
    ...
    /*
     * Locking a text block is meant to stop accidental edits, not to stop
     * navigation, so links stay reachable inside otherwise inert content.
     */
  ...
  override renderGfxBlock() {
    ...
    const containerStyle: StyleInfo = {
      ...
      border: `1px solid ${editing ? 'var(--affine-primary-color)' : 'transparent'}`,
      borderRadius: '4px',
