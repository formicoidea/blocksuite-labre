...
| Test                                                          | Demands                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `all/__tests__/commands/registry.unit.spec.ts`                | a descriptor for every framework and a framework for every descriptor; unique command ids prefixed by the framework id; an `iconKey` on every command; a chord prefix that is unique and not a reserved edgeless key; at most 14 senior-menu nominations (the cap plus the native import); every command in the catalogue |
